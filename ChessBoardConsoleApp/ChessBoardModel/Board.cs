            ...
            switch (chessPiece)
            {
                ...
                case "Queen":
                    ...
                    for (int i = (Size * -1); i < Size; i++)
                    {
                        ...
                        MarkLegalMove(currentCell.RowNumber - 1, currentCell.ColumnNumber + 1);
                        MarkLegalMove(currentCell.RowNumber, currentCell.ColumnNumber + 1);
                        MarkLegalMove(currentCell.RowNumber + 1, currentCell.ColumnNumber + 1);
                        MarkLegalMove(currentCell.RowNumber + 1, currentCell.ColumnNumber);
                        MarkLegalMove(currentCell.RowNumber + 1, currentCell.ColumnNumber - 1);
                        MarkLegalMove(currentCell.RowNumber, currentCell.ColumnNumber - 1);
                        MarkLegalMove(currentCell.RowNumber - 1, currentCell.ColumnNumber - 1);
                        MarkLegalMove(currentCell.RowNumber - 1, currentCell.ColumnNumber);
